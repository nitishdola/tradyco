...
<div class="">
    ...
    {!! Form::model($business_details, array('route' => ['user.business_details.update'], 'id' => 'user.business_details.update', 'class' => 'form-horizontal row-border')) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                {!! Form::email('business_email', null, ['class' => 'form-control required', 'id' => 'business_email' ]) !!}
